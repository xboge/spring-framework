...
public enum SpelCompilerMode {
	...
	/**
	 * In immediate beans, expressions are compiled as soon as possible (usually after 1 interpreted run).
	 * If a compiled expression fails it will throw an exception to the caller.
	 */
	IMMEDIATE,

	/**
	 * In mixed beans, expression evaluation silently switches between interpreted and compiled over time.
	 ...
	 * interpreted beans. It may subsequently compile it again later.
	 */
	MIXED
